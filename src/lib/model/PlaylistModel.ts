...
export default class PlaylistModel extends EndpointModel {
  ...
  async getContents(endpoint: Endpoint): Promise<any> {
  ...
  async #getContinuationItems(continuation: PageElement.Continuation, recursive = true, currentItems: SectionItem[] = []) {
